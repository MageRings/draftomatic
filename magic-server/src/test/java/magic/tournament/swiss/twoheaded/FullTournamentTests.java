        ...
        return Arrays.asList(new Object[][] {
                {
                        ...
                        ImmutableSortedSet.of(
                                ...
                                new TieBreakers(MIKE, 3, .665, .5, .665, IGNORED),
                                new TieBreakers(KIMBERLY, 3, .665, .5, .665, IGNORED),
                                new TieBreakers(SAM, 3, .665, .5, .665, IGNORED),
                               new TieBreakers(RED_HULK, 3, .665, .5, .665, IGNORED),
